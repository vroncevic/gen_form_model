...
from gen_form_model.infrastructure.cli.setup.options import CLIBundleOptions
from gen_form_model.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_form_model.infrastructure.cli.setup.bundle import CLIBundle
from gen_form_model.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_form_model.infrastructure.command.icommand_definition import ICommandDefinition
from gen_form_model.infrastructure.command.icommand_executor import ICommandExecutor
from gen_form_model.infrastructure.command.gen_form_model_command_definition import (
    GenFormModelCommandDefinition
)
from gen_form_model.infrastructure.command.gen_form_model_command_executor import (
    GenFormModelCommandExecutor
)
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenFormModelCommandDefinition()
        service_executor: ICommandExecutor = GenFormModelCommandExecutor(
