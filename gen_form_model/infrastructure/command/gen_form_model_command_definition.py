...
Info
    Defines GenFormModelCommandDefinition class.
'''
...
class GenFormModelCommandDefinition:
    '''
        CLI subcommand metadata definition for form model generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate form model (django or flask)'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            ...
            OptionData(
                name="--type",
                help_text="Form model type (django | flask)",
                action=None,
                default="django",
                required=True,
