...
Info
    Defines GenFormModelCommandExecutor class.
'''
...
from gen_form_model.infrastructure.command.icommand_definition import (
    ICommandDefinition
)
...
class GenFormModelCommandExecutor:
    '''
        Command executor strategy for generating form model files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenFormModelCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenFormModelCommandExecutor as string representation.

            :return: The GenFormModelCommandExecutor as string representation.
        '''
        return to_str(self)
