...
Info
    Validator for the gen_form_model bundle options.
'''
...
class GenFormModelBundleOptionsValidator:
    '''
        Validator for the gen_form_model bundle options.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_form_model bundle options.
                | is_valid - Checks if the gen_form_model bundle options is valid.
    '''

    @classmethod
    def validate(cls, options: GenFormModelBundleOptions) -> None:
        '''
            Validates the gen_form_model bundle options.

            :param options: The gen_form_model bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_form_model_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_form_model bundle options must be provided'
        msg_options_istype: str = 'the gen_form_model bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenFormModelBundleKeys.get_option_to_type().items():
    ...
    @classmethod
    def is_valid(cls, options: GenFormModelBundleOptions) -> bool:
        '''
            Checks if the gen_form_model bundle options is valid.

            :param options: The gen_form_model bundle options to be checked.
