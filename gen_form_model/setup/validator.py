...
Info
    A validator for the gen_form_model bundle.
'''
...
class GenFormModelBundleValidator:
    '''
        A validator for the gen_form_model bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_form_model bundle.
                | is_valid - Checks if the gen_form_model bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenFormModelBundle) -> None:
        '''
            Validates the gen_form_model bundle.

            :param bundle: The gen_form_model bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_form_model_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_form_model bundle must be provided'
        msg_bundle_istype: str = 'the gen_form_model bundle must be an instance of GenFormModelBundle'
        ...
        istype(bundle, GenFormModelBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: GenFormModelBundle) -> bool:
        '''
            Checks if the gen_form_model bundle is valid.

            :param bundle: The gen_form_model bundle to be checked.
