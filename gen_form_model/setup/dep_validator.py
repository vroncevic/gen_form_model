...
Info
    Validator for the gen_form_model bundle dependencies.
'''
...
class GenFormModelBundleDependenciesValidator:
    '''
        Validator for the gen_form_model bundle dependencies.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_form_model bundle dependencies.
                | is_valid - Checks if the gen_form_model bundle dependencies is valid.
    '''

    @classmethod
    def validate(cls, dependencies: GenFormModelBundleDependencies) -> None:
        '''
            Validates the gen_form_model bundle dependencies.

            :param dependencies: The gen_form_model bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_form_model_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_form_model bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_form_model bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenFormModelBundleKeys.get_dependency_to_type().items():
    ...
    @classmethod
    def is_valid(cls, dependencies: GenFormModelBundleDependencies) -> bool:
        '''
            Checks if the gen_form_model bundle dependencies is valid.

            :param dependencies: The gen_form_model bundle dependencies to be checked.
