...
Info
    GenFormModel bundle options for the gen_form_model bundle.
'''
...
class GenFormModelBundleOptions(TypedDict):
    '''
        GenFormModel bundle options for the gen_form_model bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_form_model bundle.
    '''
