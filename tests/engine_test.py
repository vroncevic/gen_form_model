...
Module
    engine_test.py
Info
    Unit tests for GenFormModel engine.
'''
...
from gen_form_model.engine import GenFormModel
...
class TestGenFormModel(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_form_model/infrastructure/config/gen_form_model.cfg',
                use_generator=True,
    ...
    @patch('gen_form_model.setup.validator.GenFormModelBundleValidator.validate')
