...
Module
    registry_test.py
Info
    Unit tests for GenFormModelBundleRegistry class.
'''
...
class TestGenFormModelBundleRegistry(unittest.TestCase):
    ...
    def test_create_bundle_success(self) -> None:
        ...
        bundle = GenFormModelBundleRegistry.create_bundle(dependencies)
