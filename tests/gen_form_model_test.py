...
Info
    Defines class GenFormModelTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of GenFormModel.
Execute
    python3 -m unittest -v gen_form_model_test
'''
...
class GenFormModelTestCase(TestCase):
    '''
        Defines class GenFormModelTestCase with attribute(s) and method(s).
        Creates test cases for checking functionalities of GenFormModel.
        GenFormModel unit tests.
    ...
    def test_default_create(self) -> None:
        ...
        generator: GenFormModel = GenFormModel()
    ...
    def test_missing_args(self) -> None:
        ...
        sys.argv.insert(1, 'gen_form_model_run.py')
        generator: GenFormModel = GenFormModel()
