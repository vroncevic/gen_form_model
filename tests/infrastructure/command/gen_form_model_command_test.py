...
'''
Module
    gen_form_model_command_test.py
Info
    Unit tests for GenFormModelCommandDefinition and GenFormModelCommandExecutor.
'''
...
class TestGenFormModelCommand(unittest.TestCase):

    def test_definition(self) -> None:
        definition = GenFormModelCommandDefinition()
        self.assertEqual(definition.name, 'create')
        self.assertEqual(
            definition.help_text, 'Generate form model (django or flask)'
        )
    ...
    def test_executor_execute_success(self) -> None:
        definition = GenFormModelCommandDefinition()
        executor = GenFormModelCommandExecutor(definition)
