...
setup(
    name='gen_form_model',
    version='2.0.1',
    description='Form model generator based on Django and Flask',
    ...
    keywords='setup, python, install, form model, django, flask, generator',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    install_requires=['ats-utilities'],
    package_data={'gen_form_model': find_package_data('gen_form_model')}
)
