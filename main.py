...
Info
    Main entry point for Form Model Generator CLI.
'''
...
def main() -> bool:
    '''
        Bootstraps and runs the gen_form_model with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_form_model: GenFormModel = GenFormModel(
        GenFormModelBundleFactory.create_bundle()
    )

    return gen_form_model.process()


if __name__ == '__main__':
    '''
        Entry point for gen_form_model execution.
